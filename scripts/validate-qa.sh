...
node --test "$PROJECT_ROOT/scripts/list-unshipped-extension-changes.test.mjs"
node --test "$PROJECT_ROOT/scripts/macos-extension-provenance.test.mjs"
node --test "$PROJECT_ROOT/scripts/build-provenance.test.mjs"
