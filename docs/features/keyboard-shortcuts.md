...
Cmd+Shift+↑    Row above
Cmd+Shift+↓    Row below
Cmd+Shift+←    Column left
Cmd+Shift+→    Column right
...
- [Text Formatting](formatting.md) - Formatting details
- [Block Types](blocks.md) - All block types
- [Core Editor](editor.md) - Editor basics
