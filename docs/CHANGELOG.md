...
- **Long prompts have room (Sprint 122).** The Agent Chat composer grows with what you write up to eight lines (it used to stop at about five), and you can drag its corner to make it taller or shorter; the height you choose is kept while Ritemark is open. The send button and model control always stay visible, including at large zoom levels.
