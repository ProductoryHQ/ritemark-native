...
- **One toolbar for Word and PDF previews (Sprint 124).** Page N of M with previous / next, zoom, fit width and fit page. Word previews add search (Cmd/Ctrl+F, a count, Enter / Shift+Enter, Escape), follow edits made in another app, and always offer **Open in Word** — or Pages, or the default app, when Word isn't installed.
