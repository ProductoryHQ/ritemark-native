...
- [ ] Windows: after Jarmo's installer test, upload `Ritemark-Setup.exe` (SHA `93f9adce…`) to the release, regenerate the feed with all three assets and re-upload, verify `latest/download/Ritemark-Setup.exe`, then move the README and getting-started download links to v1.10.1.
...
| --- | --- | --- | --- | --- |
| Windows x64 | `93f9adce…77250` (candidate 3) | passed (CI roundtrip, 46 PEs) | n/a | Jarmo testing |
