...
![](./images/image-1770052810974.png)
...
![](./images/image-1770052831862.png)
...
![](./images/image-1770052851020.png)
...
![](./images/image-1770052920340.png)
...
![](./images/image-1770052949956.png)
...
## Building Flows with Claude Code

If you use [Claude Code](https://claude.ai/download), you can ask it to help build flows for you.

**Example prompts:**

- "Create a flow that generates a blog post and hero image from a topic"
- "Build a flow to summarize documents and extract key points"
- "Make a content pipeline that creates social media posts from a product description"

Claude Code can generate flow JSON files based on your requirements. Save the generated file to `.ritemark/flows/` in your workspace.

**Tip:** Share an existing `.flow.json` file with Claude Code so it understands the format, then ask it to create new flows based on that structure.
...
![](./images/image-1770053061626.png)