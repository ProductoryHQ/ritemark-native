...
-   Decide Workspace Trust strategy for Ritemark's document-first product.
    
-   Candidate fix: add `"security.workspace.trust.enabled": false` to `branding/product.json` under `configurationDefaults`.
