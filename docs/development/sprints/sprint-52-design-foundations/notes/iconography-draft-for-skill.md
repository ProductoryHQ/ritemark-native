# DRAFT — copy into `.claude/skills/ritemark-design/references/iconography.md`

**Why this file exists:** tooling permission hooks denied direct edits to `.claude/skills/ritemark-design/references/iconography.md` during the Lucide → Phosphor migration. Jarmo needs to manually apply the content below, replacing the existing Lucide-default content.

Once applied, this draft file can be deleted.
