...
> **Gate:** Phase 0 may create research, fixtures, protocol/schema candidates, and design evidence only. Product code starts after Jarmo approves depth and the complete Phase 0 freeze.

## Phase 0: Audit, design, and freeze (W0 — R1–R9)
...
- [ ] Approve [design.md](./design.md) and full versus surgical scope.
...
## Phase 5: UX, flag, migration, and regression (W6 — R9)
