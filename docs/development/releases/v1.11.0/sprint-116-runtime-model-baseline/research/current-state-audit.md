...
|---|---|---|
| F1 | The manifest is now component-aware and includes 13 rows, not the older one-binary-per-runtime assumption. | The audit must compare complete component sets and preserve platform-only Codex helpers. |
