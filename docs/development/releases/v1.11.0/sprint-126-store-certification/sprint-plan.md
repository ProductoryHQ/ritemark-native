...
6. Produce behavioral spec, scenarios, technical plan and tasks, including per-finding evidence ownership. Jarmo approves this scope before implementation begins on a dedicated branch.
