...
**Status:** In development — Sprints 109–114 repository work are merged; Sprint 115 editor–disk sync is in validation/closeout on its dedicated branch after focused tests and live Markdown/CSV/multi-view/conflict evidence. Sprint 114 signed-candidate, hosting, Store, SAC-On, and exact-hash gates plus residual release-level manual matrices remain open.<br>
**Target:** v1.10.0<br>
...
| [Sprint 115 — Reliable Editor–Disk Synchronization](./sprint-115-editor-disk-sync/sprint-plan.md) | [#221](https://github.com/ProductoryHQ/ritemark-native/issues/221) | Open — closes with PR | `codex/sprint-115-editor-disk-sync` | [#222](https://github.com/ProductoryHQ/ritemark-native/pull/222) | Validated PR ready for merge; blocks release candidate until merged | 26/26 focused tests, compile/typecheck/build, official repository QA, live focused Markdown, CSV, multi-view, conflict/Undo, and content-free diagnostics pass; explicit release-candidate matrix retained | Changelog, release notes, checklist, architecture, and sprint evidence updated | PR ready 2026-08-25 |
