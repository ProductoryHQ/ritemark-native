...
| [Sprint 114 — Trusted Windows Install](./sprint-114-trusted-windows-install/sprint-plan.md) | [#212](https://github.com/ProductoryHQ/ritemark-native/issues/212) | Open | `codex/sprint-114-trusted-windows-install` | — | Repo-owned code complete; protected signed-canary and external Windows proof remain open | Focused contracts and official local QA pass; signing-environment, signed runner, SAC-On, Store, and hosting evidence open | Drafted; claims remain gated | Active 2026-08-24 |
