...
**Status:** In development — Sprint 109 merge-ready; PR/merge pending, native Windows retained at the v1.10 candidate gate<br>
**Target:** v1.10.0<br>
...
|---|---|---|---|---|---|---|---|---|
| [Sprint 109 — Durable Chat History](./sprint-109-durable-chat-history/sprint-plan.md) | [#205](https://github.com/ProductoryHQ/ritemark-native/issues/205) | Open | `codex/sprint-109-durable-chat-history` | — | Merge-ready | Focused tests, compile/typecheck/build, official QA, and macOS `ritemark-demo` visual/accessibility evidence pass; native Windows retained at release candidate gate | Changelog, checklist, and three screenshots drafted | Merge-ready 2026-08-23; PR/merge pending |
