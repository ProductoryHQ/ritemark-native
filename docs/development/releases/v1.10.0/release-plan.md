...
- **Gate 1 / arm64:** packaged Claude picker/mismatch replay; authenticated restart and failure injection; reduced-motion visual verification; residual Insights negative/accessibility/theme rows; editor-sync receipt-loss, focused/blurred, continuous typing, delayed autosave, burst writes, front-matter/properties/comments/images/CSV integrity, accessibility/theme/zoom, generic-process/formatter/exact-runtime origins, multi-root/standalone, rapid/large-file, lifecycle, and previous-epoch rows; signed/notarized/stapled DMG install, signature, mount, Gatekeeper, content, and hash verification. Jarmo tests only after the final artifact has passed those technical checks.
