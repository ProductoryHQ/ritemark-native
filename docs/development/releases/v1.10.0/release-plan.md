...
| [Sprint 111 — Agent Runtime Refresh](./sprint-111-agent-runtime-refresh/sprint-plan.md) | [#207](https://github.com/ProductoryHQ/ritemark-native/issues/207) | Open | `codex/sprint-111-agent-runtime-refresh` | — | Native darwin-x64/Windows CI pending | Exact 9-artifact gate, deterministic suite, official QA, arm64 runtime smoke, and release preflight pass | Runtime refresh section drafted | QA passed locally — native CI next |
