...
| [Sprint 114 — Trusted Windows Install](./sprint-114-trusted-windows-install/sprint-plan.md) | [#212](https://github.com/ProductoryHQ/ritemark-native/issues/212) | Open | `codex/sprint-114-trusted-windows-install` | [#218](https://github.com/ProductoryHQ/ritemark-native/pull/218) | Lean implementation in review; signed Windows run and external proof remain open | Focused local tests and QA required; signed runner, SAC-On, Store, and hosting checks open | Drafted; claims remain gated | Active 2026-08-24 |
