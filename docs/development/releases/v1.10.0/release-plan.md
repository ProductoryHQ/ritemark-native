...
**Status:** Release candidate preparation — Sprints 109–115 repository work are merged into `main`; the v1.10.0 arm64 app is built and Developer ID signed, while canonical DMG creation, dependency-security disposition, Sprint 114 immutable hosting/Store/SAC-On/exact-hash work, and residual release-level manual validation remain open.<br>
**Target:** v1.10.0<br>
...
| Production parser/render dependencies carry current high npm advisories | High | Audit exploit reachability; apply reviewed fixed dependency pins where available; replace or contain `xlsx@0.18.5`; rerun document, spreadsheet, Markdown, Mermaid, bundle, and release QA | Open — 2026-08-25 RC security triage; no blind `npm audit fix` |
