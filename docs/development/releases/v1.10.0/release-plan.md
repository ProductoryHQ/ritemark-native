...
| [Sprint 113 — Transcribe Insights Output](./sprint-113-transcribe-insights-output/sprint-plan.md) | [#208](https://github.com/ProductoryHQ/ritemark-native/issues/208) | Open | `codex/sprint-113-transcribe-insights-output` | — | Rebased onto Sprint 112 plus merged review polish at `fb0d3a3`; combined webview bundle regenerated at implementation commit `8752982`; PR/merge pending manual evidence | Focused tests, extension/webview typechecks/build, repository QA, and independent full QA pass; authenticated manual UI/accessibility evidence pending | Changelog, release notes, checklist, user docs, and architecture docs drafted | QA handoff — manual matrix open |
