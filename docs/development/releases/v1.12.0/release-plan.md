...
| Sprint 122 | `sprint-122-conversation-clarity` | TBD | #282 | Implemented; RunDev-validated in a dev build (2026-09-23), evidence in the sprint's `qa-evidence.md` | full `npm test` + both typechecks green; `validate-qa.sh` passed | drafted in `docs/releases/v1.12.0/release-notes.md` |
