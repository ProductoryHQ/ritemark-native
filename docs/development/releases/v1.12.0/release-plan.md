...
| Sprint 125 | `sprint-125-powerpoint-preview` | TBD | #285 | in review; RunDev-validated in a dev build, evidence in the sprint's `qa-evidence.md` | full `npm test` + both typechecks green; `validate-qa.sh` passed | drafted in `docs/releases/v1.12.0/release-notes.md` |
