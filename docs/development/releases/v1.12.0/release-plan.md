...
| Sprint 123 | `sprint-123-findability` | TBD | #283 | in review; RunDev-validated in a dev build, evidence in the sprint's `qa-evidence.md` | full `npm test` green; `validate-qa.sh` passed | drafted in `docs/releases/v1.12.0/release-notes.md` |
