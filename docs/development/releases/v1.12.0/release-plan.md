...
| [Sprint 127](./sprint-127-day-zero-models/sprint-plan.md) | New Anthropic models on day zero | A newly released Anthropic model can be chosen in the Claude Code agent within minutes, with no CLI or Ritemark update | [#343](https://github.com/ProductoryHQ/ritemark-native/issues/343) | none in the app; the publisher needs `ritemark-public` applied by Jarmo and a Ritemark Anthropic API key | In progress; plan approved 2026-09-24 |
...
| Sprint 127 | `sprint-127-day-zero-models` | TBD | #343 | in progress (plan approved 2026-09-24); local `sprint-127-day-zero-models`, pushed to `claude/anthropic-models-bundled-cli-gtjld9` | not run | not drafted |
