...
### Sprint 127 — New Anthropic models on day zero (proposed)
...
- [ ] Sprint 127, if approved into this release: merged; its issue closed or explicitly deferred with evidence; the publisher's first automatic publish is recorded; on a release candidate, a subscription account sees and runs a feed-published model on the bundled CLI.
...
| Sprint 127 | `sprint-127-day-zero-models` | TBD | pending ([draft](./sprint-127-day-zero-models/research/github-issue-draft.md)) | proposed 2026-09-24; the plan awaits approval (planning documents on `claude/anthropic-models-bundled-cli-gtjld9`) | not run | not drafted |
