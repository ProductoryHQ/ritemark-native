...
| Sprint 127 | `sprint-127-day-zero-models` | TBD | #343 | in development; D4 scope change 2026-09-24 (Claude Code 2.1.281, pre-release check, publisher withdrawn). Local `sprint-127-day-zero-models`, pushed to `claude/anthropic-models-bundled-cli-gtjld9` | full `npm test` green and `tsc --noEmit` clean after the D4 change (2026-09-24); `check:anthropic-models` passes; manual QA not run | drafted in `docs/releases/v1.12.0/release-notes.md` |
