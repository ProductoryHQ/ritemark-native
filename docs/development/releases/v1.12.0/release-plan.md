...
| Sprint 124 | `sprint-124-word-preview-fidelity` | TBD | #284; follow-up #344 (PDF search) | in review; RunDev-validated in a dev build, evidence in the sprint's `qa-evidence.md` | full `npm test` green; `validate-qa.sh` passed | drafted in `docs/releases/v1.12.0/release-notes.md` |
