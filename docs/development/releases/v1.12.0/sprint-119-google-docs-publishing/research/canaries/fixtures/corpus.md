...
HTML-ish content that must not execute: <script>alert(1)</script> and <img src=x onerror=alert(1)>.

Ritemark standalone comment follows this line.

<!-- {id:c-test-1} This is a Ritemark comment that must never reach Google. -->
...
![Ritemark logo](https://ritemark.app/favicon.ico)
