...
const file='normal-performance-observed-load-probe.json';
...
try{
 ...
 for(const [index,rate] of [1,4,4,1,1,4].entries()){
  ...
  trial.profileFile=`normal-performance-observed-trial-${trial.index}.cpuprofile`;
  trial.coverageFile=`normal-performance-observed-trial-${trial.index}-coverage.json`;
