...
const file='normal-performance-measured-load-probe.json';
...
try{
 ...
 for(const [index,rate] of [1,4,4,1,1,4].entries()){
  ...
  trial.profileFile=`normal-performance-measured-trial-${trial.index}.cpuprofile`;
  trial.coverageFile=`normal-performance-measured-trial-${trial.index}-coverage.json`;
