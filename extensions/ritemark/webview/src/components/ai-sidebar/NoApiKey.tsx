  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center px-5 text-center">
      <div className="w-10 h-10 rounded-full bg-[var(--vscode-input-background)] flex items-center justify-center mb-3">
        <Icon name="key" size={20} className="opacity-60" />
      </div>
      ...
      <button
        ...
        className="px-4 py-1.5 text-xs rounded bg-[var(--r-accent)] text-[var(--vscode-button-foreground)] hover:bg-[var(--vscode-button-hoverBackground)]"
      >
        Configure API Key
      </button>
    </div>
