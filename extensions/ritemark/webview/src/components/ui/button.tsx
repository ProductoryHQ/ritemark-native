...
// Sprint 122: forwards its ref (React 18 drops `ref` on a plain function
// component), so a Button can be a Radix trigger — a menu or popover needs the
// trigger's element to place itself.
